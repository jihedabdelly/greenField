      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto">
          <li className="nav-item active">
            <Link to="home" className="nav-link waves-effect waves-light">
          ...
          <li className="nav-item">
            <Link to="Children" className="nav-link waves-effect waves-light">
              Children
            </Link>
          </li>
        </ul>
        <ul className="navbar-nav nav-flex-icons">
          ...
          <li className="nav-item">
            <Link to="Login" className="nav-link waves-effect waves-light">
